...
class Usuario extends Conexion
{
	...
	=============================================*/
        ...
        public function verificarExistenciaDb(){
         ...
         try {
             self::getConexion();
                $resultado = self::$cnx->prepare($query);		
                $email= $this->getEmail();	
                $resultado->bindParam(":email",$email,PDO::PARAM_STR);//pdo usa para sustituir por otro tipo string
                $resultado->execute();
                self::desconectar();
                $encontrado = false;
        ...
        public function guardarEnDb(){
            $query = "INSERT INTO `usuarios`(`email`, `nombre`, `clave`, `imagen`, `telefono`, `estado`, `cambioContrasena`, `created_at`) VALUES (:email,:nombre,:clave,:imagen,:telefono,:estado,:cambioContrasena,now())";//now es la fecha actual
         try {
             self::getConexion();
             $email=$this->getEmail();
